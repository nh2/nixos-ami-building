...
# nh2: Replace this by your AMI upload bucket's region shown in S3.
home_region=eu-central-1
# nh2: Replace this by your AMI upload bucket's name shown in S3.
bucket=nixos-ami-building-vmimportbucket-prf5j5yydsx3
...
upload_image() {
    ...
    # nh2: Commented out to not make my image public.
...
upload_all() {
    ...
    # nh2: Multi-region upload loop commented out.
